...
const testimonials = [
    ...
    {
        message:'I love coming to this cafe. The pastries are always fresh, and the staff is incredibly friendly. It',
        name:"Michael Lee",
                ...
                <div className=' flex justify-center h-full
                 xl:pt-14'>
                    <div className=' max-w-[60%] text-primary'>
                      <IoMdQuote  className=' mx-auto text-6xl  text-primary
                       mt-12'/>
                       <p className=' text-2xl
                        font-secondary text-center mt-8'>{person.message}</p>
                   <div className=' text-center'>
                   <p className=' text-xl font-bold mt-1'>{person.name}</p>

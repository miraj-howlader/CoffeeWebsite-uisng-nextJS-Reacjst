...
const About = () => {
    const scrollabelSectionRef = useRef(null)
    const scrollTriggerRef = useRef(null)

    useLayoutEffect(()=>{
        gsap.registerPlugin(ScrollTrigger)
        const animation = gsap.fromTo(
            scrollabelSectionRef.current,
            {translateX:0},
            {translateX:'-200vw',ease:'none',duration:2,scrollTrigger:{
  ...
  return (
    <section className=" overflow-hidden bg-primary">
      <div ref={scrollTriggerRef}>
        <div ref={scrollabelSectionRef} className=" h-screen w-[300vw] flex relative">
            {data.map((item,index)=>{
                      ...
                      <div className=" flex gap-[30px] relative">
                          ...
                          <div className=" flex-1 flex flex-col justify-center
                           ...
                           <div className=" max-w-[560px] text-center">
                            ...
                            {/* description  */}
                            <p className=" leading-relaxed mb-16 px-8
                             xl:px-0">{item.description}</p>
                             {/* btn  */}

...
const Hero = () => {
  return (
    <section className=" h-[80vh] xl:h-screen relative text-white ">
      {/* overlay  */}
      <div
        className=" bg-hero_overlay absolute w-full h-full z-10 
       bg-primary/[0.93]"
      ></div>
      {/* video  */}
      <video
      ...
      >
        ...
        data-scroll-speed='0.4'
         ...
         justify-center items-center xl:pb-12 gap-10 h-full">
          {/* badge and h1  */}
         <div className=" flex flex-col items-center">
         <Badge containerStyles='hidden xl:flex xl:w-[180px]
         xl:h-[180px]'/>
         ...
         xl:max-w-[560px] mb-4">Experience the joy of exceptional coffee in our cozy space, where every cup is crafted with passion and warmth
          </p>
